...
class TeacherPromptBartModel(nn.Module):
    def __init__(self, tokenizer, label_ids, args):
        super(TeacherPromptBartModel, self).__init__()
...
class TeacherPromptGeneratorModel(nn.Module):
    def __init__(self, prompt_model, max_length=20, max_len_a=0.0, num_beams=1,
        ...
        super(TeacherPromptGeneratorModel, self).__init__()
